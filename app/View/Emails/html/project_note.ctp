								...
								<table bgcolor="#FFF" border="0" cellspacing="0" cellpadding="20" width="100%">
									<tr>
										<td width="100%" bgcolor="#FFF" style="text-align:left;">
											<p>
												<?php echo __('Querido equipo');?>,
											</p>
											
											<p><?php echo __('Un proyecto ha sido')?> <?php if($is_update){?><?php echo __('updated');?><?php }else{ ?><?php echo __('added');?><?php } ?> <?php echo __('in');?> "<b><?php echo $pname;?></b>".</p> 
