...
$year = gmdate('Y');
$newEmailFooter = 'Copyright ' . $year . ' Departamento de Planificación, Procesos e Innovación EPM. All Rights Reserved.<br>
                    Ibarra, Imbabura, Ecuador, EC
                    <br><br>
                    <a style="color:#2489B3; font-weight:normal; text-decoration:underline;" href="https://webmail.movidelnor.gob.ec/">Correo Institucional</a>
                    .
                    <a style="color:#2489B3; font-weight:normal; text-decoration:underline;" href="http://quipux.movidelnor.gob.ec/quipux/login.php">SGD Quipux</a>
                    .
                    <a style="color:#2489B3; font-weight:normal; text-decoration:underline;" href="https://www.movidelnor.gob.ec/webepm/uniportalepm">Sitio Web EPM</a>
                    .
                    <a style="color:#2489B3; font-weight:normal; text-decoration:underline;" href="https://eduvirtual.movidelnor.gob.ec/cursos">Aula Virtual</a>

                    <br><br>
                    <a style="color:#2489B3; font-weight:normal; text-decoration:underline;" href="https://twitter.com/epm_movidelnor"><img src="'.HTTP_ROOT.'img/tw.png" alt="Twitter" style="width:32px;height:32px"></a>
                    <a style="color:#2489B3; font-weight:normal; text-decoration:underline;" href="https://www.facebook.com/pages/epm_movidelnor"><img src="'.HTTP_ROOT.'img/fb.png" alt="Facebook" style="width:32px;height:32px"></a>
